...
void setup() {
  ...
  for(i = 0; i < 24; i++){
    ...
    Serial.printf(" que eh ");
    Serial.println((((float)mWb)-100)/100);
    delay(500);
    
    Serial.printf("Salvando Wl : ");
    Serial.print(Wl);
    ...
    Serial.printf(" que eh ");
    Serial.println((((float)mWl)-100)/100);
    delay(500);
    
    Serial.printf("Salvando Wm : ");
    Serial.print(Wm);
    ...
    Serial.printf(" que eh ");
    Serial.println((((float)mWm)-100)/100);
    delay(500);
    
    Serial.printf("Salvando Ld : ");
    Serial.print(Ld);
    mLd = (uint8_t) (Ld*100);
  ...
  Serial.println("lembrando os valores");
  for(i=0;i<120;i++){    
    Serial.println(EEPROM.read(i));
    if(i == 23 || i == 47 || i == 71 || i == 95){
      Serial.println("outra variavel");
    }
  }
