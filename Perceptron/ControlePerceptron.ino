...
int tempoPerceptron = 10000;//tempo em que é realizado o perceptron
int contDesliga = 0; 
...
void pCallback(void *tCall){
    realizaPerceptron = true;
}

void criaTimerParaPerceptron(){
  os_timer_setfn(&pTimer, pCallback, NULL);
  os_timer_arm(&pTimer, tempoPerceptron, true);
}
